      ...
      <div className="row attraction">
        ...
        <div className="col-md-6">
          <div className="videoArea">
            <iframe src="https://www.youtube.com/embed/i4Zt3JZejbg" width="620" height="350" frameborder="0" />
            <img
            ...
            />
            <img
              className="tc shadow-lg p-3 bg-white rounded rounded-circle position-absolute mt-5"
              src={TC22}
              alt=""
            />
          </div>
